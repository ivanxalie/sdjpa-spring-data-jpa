...
public class DaoIntegrationTest {
    ...
    void testGetBookByNameNotFound() {
        assertThrows(EntityNotFoundException.class, () ->
                bookDao.findBookByTitle("Cheeky Bastards, Vol. 2 Extended Brutal Edition"));
    }
    ...
    void testGetAuthorByNameNotFound() {
        assertThrows(EntityNotFoundException.class, () -> authorDao
                .findAuthorByName("Legends", "Of Tomorrow"));
    }
